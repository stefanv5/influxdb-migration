...
- [ ] **Step 1: Update TDengine QueryData signature**

The signature already accepts `cfg *types.QueryConfig` from batch size task.

- [ ] **Step 2: Update time window logic**
...
- [ ] **Step 1: Parse TimeWindow from mapping**
...
- [ ] **Step 2: Pass queryCfg to TDengine QueryData**
...
|------|-------------|-------|--------|
| 1 | Add TimeWindow to QueryConfig | `pkg/types/query_config.go` | - [ ] |
| 2 | TDengine Source | `internal/adapter/source/tdengine.go` | - [ ] |
| 3 | Migration Engine | `internal/engine/migration.go` | - [ ] |
